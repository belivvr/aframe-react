 ...
 *
 * The [raycaster component](https://aframe.io/docs/1.3.0/components/raycaster.html) uses the line component for its showLine property,
 * which is then used by the [laser-controls component](https://aframe.io/docs/1.3.0/components/laser-controls.html).
 *
