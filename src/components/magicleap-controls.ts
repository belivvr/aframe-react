 ...
 * It wraps the [tracked-controls component](https://aframe.io/docs/1.3.0/components/tracked-controls.html) while adding button mappings, events, and Magic Leap controller model/
 *
 * @see https://aframe.io/docs/1.3.0/components/magicleap-controls.html#sidebar
 */
