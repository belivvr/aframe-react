...
export interface ObjModelProps {
  /**
   * Selector to an `<a-asset-item>` pointing to a .MTL file or an inline path to a .MTL file. Optional if you wish to use the [material component](https://aframe.io/docs/1.3.0/components/material.html) instead.
   */
  mtl?: string;
...
export class ObjModel extends Component<ObjModelProps> {
  readonly mtl?: string;
