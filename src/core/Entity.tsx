...
/**
 * A-Frame represents an entity via the `<a-entity>` element. As defined in the [entity-component-system pattern](https://aframe.io/docs/1.3.0/introduction/entity-component-system.html),
 ...
 * [position](https://aframe.io/docs/1.3.0/components/position.html),
 * [rotation](https://aframe.io/docs/1.3.0/components/rotation.html), and
 * [scale](https://aframe.io/docs/1.3.0/components/scale.html) components.
 *
