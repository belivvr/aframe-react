 ...
 * @example
 * ```tsx
 * <Tetrahedron color="#FF926B" radius={5} />
 * ```
 */
export default function Tetrahedron(props: Props & EntityProps): JSX.Element {
  const tetrahedronKeys = [
    'ambientOcclusionMap',
    'ambientOcclusionMapIntensity',
    'ambientOcclusionTextureOffset',
    'ambientOcclusionTextureRepeat',
  ...
  return (
    <a-tetrahedron
      {...toProps(props, tetrahedronKeys)}
      {...toTetrahedronProps(props)}
    >
      {children}
    </a-tetrahedron>
  );
